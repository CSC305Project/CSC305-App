                      ...
                      children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'EDIT_GOAL_PAGE_arrow_back_ICN_ON_TAP');
                                      logFirebaseEvent(
                                          'IconButton_navigate_to');

                                      context
                                          .pushNamed(GoalPageWidget.routeName);
                                    },
                                  ),
                                ),
                              ),
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent('EDIT_GOAL_PAGE__BTN_ON_TAP');
                        ...
                        Align(
                          alignment: AlignmentDirectional(-0.04, 0.65),
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'EDIT_GOAL_PAGE_SUBMIT_BTN_ON_TAP');
                              if (_model.editingMode) {
                                logFirebaseEvent('Button_backend_call');

                                await widget.goalDoc!.reference
