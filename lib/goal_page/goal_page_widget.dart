  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<GoalsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<GoalsRecord> goalPageGoalsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final goalPageGoalsRecord = goalPageGoalsRecordList.isNotEmpty
            ? goalPageGoalsRecordList.first
            : null;
                                                              ...
                                                              padding:
                                                                  EdgeInsetsDirectional
                                                                      .fromSTEB(
                                                                          ...
                                                                          0.0),
                                                              child: Text(
                                                                'Collect all bank statements and store receipts',
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                                    .override(
                                                                    ...
                                                                    children: [
                                                                      FlutterFlowIconButton(
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'GOAL_PAGE_PAGE_edit_ICN_ON_TAP');
                                                                          logFirebaseEvent(
                                                                      ...
                                                                      FlutterFlowIconButton(
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          logFirebaseEvent(
                                                                              'GOAL_PAGE_PAGE_delete_ICN_ON_TAP');
                                                                          logFirebaseEvent(
