...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: GoalPageWidget.routeName,
          path: GoalPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'GoalPage')
              : NavBarPage(
                  initialPage: 'GoalPage',
                  page: GoalPageWidget(),
                ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'AIinsights')
              : AIinsightsWidget(),
        ),
        FFRoute(
          name: BankDashboardWidget.routeName,
          path: BankDashboardWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'BankDashboard')
              : NavBarPage(
                  initialPage: 'BankDashboard',
                  page: BankDashboardWidget(),
                ),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          asyncParams: {
            'goalDoc': getDoc(['goals'], GoalsRecord.fromSnapshot),
          },
          builder: (context, params) => EditGoalWidget(
            goalDoc: params.getParam(
              'goalDoc',
              ParamType.Document,
            ),
          ),
